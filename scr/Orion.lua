...
local BundleFactory = type(BundleFactoryModule) == "function" and BundleFactoryModule({
    OrionLib = OrionLib,
...
function OrionLib:SetStyle(style)
    if type(style) ~= "table" then return OrionLib.Style end
...
function OrionLib:MakeKeySystem(KeyConfig)
    ...
    if KeyConfig.Link then
        ...
        AddConnection(GetKey.MouseButton1Click, function()
            if setclipboard then setclipboard(KeyConfig.Link) end
    ...
    if KeyConfig.Blocking ~= false then
        repeat task.wait() until unlocked or not KeyGui.Parent
        return unlocked
    end
    return KeyGui
end
...
function KeyBindAdd()
	...
	local WindowTopBarLine = OrionLib:AddThemeObject(SetProps(MakeElement("Frame"), {
...
function OrionLib:MakeWindow(WindowConfig)
        ...
        local WindowStuff = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, OrionLib.Style.WindowRadius or 12), {
                ...
                SetChildren(SetProps(MakeElement("TFrame"), {
                        ...
                        OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("Frame"), {
                        ...
                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", LocalPlayer.DisplayName, WindowConfig.HidePremium and 14 or 13), {
                                Size = UDim2.new(1, -60, 0, 13),
                                Position = WindowConfig.HidePremium and UDim2.new(0, 50, 0, 19) or UDim2.new(0, 50, 0, 12),
                                Font = Enum.Font.GothamBold,
                                ClipsDescendants = true
                        }), "Text"),
                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", "", 12), {
        ...
        if WindowConfig.SearchBar and WindowConfig.SearchBar.Tabs == true then
                ...
                local SearchBar = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 1, 6), {
                        Parent = WindowStuff,
        ...
        local MainWindow = OrionLib:AddThemeObject(SetChildren(SetProps(MainElementGui, {
                ...
                SetChildren(SetProps(MakeElement("TFrame"), {
                        ...
                        OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 7), {
		...
		function Functions:MakeTab(TabConfig)
			...
			local function SelectTab()
				...
				for _, Tab in next, TabHolder:GetChildren() do
					if Tab:IsA("TextButton") then
                        ...
                        if Tab:FindFirstChild("Highlight") then
                            TweenService:Create(Tab.Highlight, TweenInfo.new(0.2, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 3, 0, 0), BackgroundTransparency = 1}):Play()
                        end
					end
				end
				...
				TweenService:Create(TabFrame.Ico, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {ImageTransparency = 0, Size = UDim2.new(0, TabConfig.IconOnly and 26 or 20, 0, TabConfig.IconOnly and 26 or 20)}):Play()
                ...
                if TabFrame:FindFirstChild("Highlight") then
                    TweenService:Create(TabFrame.Highlight, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 3, 0, 22), BackgroundTransparency = 0}):Play()
                end
                ...
                local function GetElements(ItemParent)
                        ...
                        function ElementFunction:AddDivider(DividerConfig)
							...
							if DividerConfig and DividerConfig.Text then
								local Label = OrionLib:AddThemeObject(SetProps(MakeElement("Label", Text, 14), {
									Size = UDim2.new(0, 0, 1, 0),
									Position = UDim2.new(0.5, 0, 0.5, 0),
									AnchorPoint = Vector2.new(0.5, 0.5),
									Parent = DividerFrame,
								...
								local LeftLine = SetChildren(OrionLib:AddThemeObject(SetProps(MakeElement("Frame"), {
								...
								local RightLine = SetChildren(OrionLib:AddThemeObject(SetProps(MakeElement("Frame"), {
									Size = UDim2.new(0.5, -10, 0, 1),
								...
								local Line = SetChildren(OrionLib:AddThemeObject(SetProps(MakeElement("Frame"), {
									Size = UDim2.new(1, 0, 0, 1),
									Position = UDim2.new(0.5, 0, 0.5, 0),
									AnchorPoint = Vector2.new(0.5, 0.5),
									Parent = DividerFrame
                        ...
                        function ElementFunction:AddLog(Text)
                                ...
                                local LogFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                                        Size = UDim2.new(1, 0, 1, 0),
                                        BackgroundTransparency = 0.7,
                                        Parent = ItemParent
                                }), {
                                        OrionLib:AddThemeObject(SetProps(Label, {
                                                Size = UDim2.new(1, -12, 1, 0),
                        ...
                        function ElementFunction:AddLabel(Text, Log)
						    ...
						    local LabelFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255,255,255), 0, 5), {
						        ...
						        OrionLib:AddThemeObject(SetProps(MakeElement("Label", Text, 15), {
						            Size = UDim2.new(1, -12, 1, 0),
						            Position = UDim2.new(0, 8, 0, 0),
						            Font = Enum.Font.GothamBold,
						            TextWrapped = true,
                        ...
                        function ElementFunction:AddParagraph(Text, Content)
                                ...
                                local ParagraphFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                                        Size = UDim2.new(1, 0, 0, 30),
                                        BackgroundTransparency = 0.7,
                                        Parent = ItemParent
                                }), {
                                        ...
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", "", 13), {
                        ...
                        function ElementFunction:AddButton(ButtonConfig)
                                ...
                                local ButtonFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                                        Size = UDim2.new(1, 0, 0, 33),
                                        Visible = ButtonConfig.Visible,
                                        Parent = ItemParent
                                }), {
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", ButtonConfig.Name, 15), {
                                                Size = UDim2.new(1, -12, 1, 0),
                                                Position = UDim2.new(0, 12, 0, 0),
                                                Font = Enum.Font.GothamBold,
                                                Name = "Content"
                                        }), "Text"),
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Image", ButtonConfig.Icon), {
                                                Size = UDim2.new(0, 20, 0, 20),
                                ...
                                AddConnection(Click.MouseEnter, function()
                                        ...
                                        TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 3)}):Play()
                                end)
                                ...
                                AddConnection(Click.MouseButton1Down, function()
		                                if ButtonConfig.Disabled then return end
                                        TweenService:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 6)}):Play()
                                end)
								...
								function Button:AddButton(ButtonConfigClone)
									...
									if ButtonFrame then
										...
										AddConnection(Click.MouseEnter, function()
		                                        ...
		                                        TweenService:Create(ButtonCloneFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 3)}):Play()
		                                end)
		                                ...
		                                AddConnection(Click.MouseButton1Down, function()
				                                if ButtonConfigClone.Disabled then return end
		                                        TweenService:Create(ButtonCloneFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 6)}):Play()
		                                end)
                        ...
                        function ElementFunction:AddHighlightButton(ButtonConfig)
                                ...
                                local ButtonFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 6), {
                                ...
                                AddConnection(Click.MouseEnter, function()
                                        ...
                                        TweenService:Create(ButtonFrame, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 0, 42)}):Play()
                                        TweenService:Create(ButtonFrame.Accent, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 6, 1, -8), Position = UDim2.new(0, 7, 0, 4)}):Play()
                                end)

                                AddConnection(Click.MouseLeave, function()
                                        if Button.Disabled then return end
                                        TweenService:Create(ButtonFrame, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 0, 38)}):Play()
                                        TweenService:Create(ButtonFrame.Accent, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 4, 1, -12), Position = UDim2.new(0, 8, 0, 6)}):Play()
                                end)

                                AddConnection(Click.MouseButton1Up, function()
                                        if Button.Disabled then return end
                                        TweenService:Create(ButtonFrame.Accent, TweenInfo.new(0.12, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2.new(0, 10, 1, -6)}):Play()
                                        OrionLib:SafeScript(ButtonConfig.Callback)
                                        task.delay(0.12, function()
                                                if ButtonFrame and ButtonFrame.Parent then
                                                        TweenService:Create(ButtonFrame.Accent, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 4, 1, -12)}):Play()
                                                end
                                        end)
                                end)
                                ...
                                function Button:SetVisible(state)
                                        Button.Visible = state
                                        if ButtonFrame then ButtonFrame.Visible = state end
                                end
                        ...
                        function ElementFunction:AddViewport(ViewportConfig)
							...
							local ViewportGui = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                        ...
                        function ElementFunction:AddImage(ImageConfig)
							...
							local ImageFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
									Name = ImageConfig.Name,
									Size = UDim2.new(1, 0, 0, FrameHeight(ImageConfig.Size)),
									Visible = ImageConfig.Visible,
									Parent = ItemParent
								}), {
								OrionLib:AddThemeObject(SetProps(MakeElement("Image", ImageConfig.Icon), {
										Name = "Icon",
										AnchorPoint = Vector2.new(0.5, 0.5),
						...
						function ElementFunction:AddVideo(VideoConfig)
						    ...
						    local VideoFrameTo = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
						        Name = VideoConfig.Name,
						        Size = UDim2.new(1, 0, 0, FrameHeight(VideoConfig.Size)),
						        Visible = VideoConfig.Visible,
						        Parent = ItemParent
						    }), {
						        OrionLib:AddThemeObject(SetProps(MakeElement("RoundVideo", Color3.fromRGB(255, 255, 255), VideoConfig.Value.Loop ~= false, VideoConfig.Value.Playing or false, 0, 10), {
						            Name = "Video",
						            AnchorPoint = Vector2.new(0.5, 0.5),
									Video = vidAsset.Icon,
							...
							function Video:SetVideo(ToChange)
								if getgenv().Destroy then return end
								if VideoFrame then
									local VideoAsster = OrionLib:MakeAsset({Icon = VideoConfig.Video}, {Root = "OrionLibSave", Folder = "OrionVideo"})
									VideoFrame.Video = VideoAsster
								end
							end
                        ...
                        function ElementFunction:AddToggle(ToggleConfig)
							...
							if ToggleConfig.Type == "Switch" then
								ToggleBox = SetChildren(SetProps(MakeElement("RoundFrame", GetThemeValue("Divider", OrionLib.Themes.Default.Divider), 0, 12), {
							...
							local ToggleFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
									Size = UDim2.new(1, 0, 0, 38),
									Parent = ItemParent
								}), {
									OrionLib:AddThemeObject(SetProps(MakeElement("Label", ToggleConfig.Name, 15), {
										Size = UDim2.new(1, -12, 1, 0),
										Position = UDim2.new(0, 12, 0, 0),
										Font = Enum.Font.GothamBold,
										Name = "Content",
									}), "Text"),
									OrionLib:AddThemeObject(MakeElement("Stroke"), "Stroke"), ToggleBox, Click,
							}), "Second")
							...
							function Toggle:SetMode(newMode)
								...
								if newMode == "Switch" then
									local newSwitch = SetChildren(SetProps(MakeElement("RoundFrame", GetThemeValue("Divider", OrionLib.Themes.Default.Divider), 0, 12), {
										Size = UDim2.new(0, 40, 0, 20),
										Position = UDim2.new(1, -8, 0.5, 0),
										AnchorPoint = Vector2.new(1, 0.5),
										Name = "Switch",
								...
								if ToggleBox then
									...
									elseif ToggleBox:FindFirstChild("Stroke") then
										TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.2), {
											Color = state and Color3.fromRGB(120,120,120) or (Toggle.Value and ToggleConfig.Color or GetThemeValue("Stroke", OrionLib.Themes.Default.Stroke))
										}):Play()
									end
								end
							...
							function Toggle:AddBind(BindConfig)
								...
								local BindBox = OrionLib:AddThemeObject(SetChildren(SetProps(
									MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
										...
										OrionLib:AddThemeObject(MakeElement("Stroke"), "Stroke"),
										OrionLib:AddThemeObject(SetProps(MakeElement("Label", Bind.Value, 14), {
											Size = UDim2.new(1, 0, 1, 0),
											Font = Enum.Font.GothamBold,
											TextXAlignment = Enum.TextXAlignment.Center,
											Name = "Value",
						...
						function ElementFunction:AddSlider(SliderConfig)
							...
							local SliderDrag = SetChildren(SetProps(MakeElement("RoundFrame", SliderConfig.Color, 0, 5), {
								...
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", "value", 13), {
									Size = UDim2.new(1, -12, 0, 14),
							...
							local SliderFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
								Size = UDim2.new(1, 0, 0, 65),
								Visible = SliderConfig.Visible,
								Parent = ItemParent
							}), {
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", SliderConfig.Name, 15), {
									Size = UDim2.new(1, -12, 0, 14),
									Position = UDim2.new(0, 12, 0, 10),
									Font = Enum.Font.GothamBold,
									Name = "Content"
                        ...
                        function ElementFunction:AddDropdown(DropdownConfig)
							...
							local DropdownContainer = OrionLib:AddThemeObject(SetProps(SetChildren(
							...
							local DropdownFrame = OrionLib:AddThemeObject(SetChildren(SetProps(
								...
								SetProps(SetChildren(MakeElement("TFrame"), {
									OrionLib:AddThemeObject(SetProps(MakeElement("Label", DropdownConfig.Name, 15), {
										Size = UDim2.new(1, -12, 1, 0),
										Position = UDim2.new(0, 12, 0, 0),
										Font = Enum.Font.GothamBold,
										Name = "Content"
							...
							local function AddOptions(Options)
								for k, v in pairs(Options) do
									...
									table.insert(Elements, OrionLib:AddThemeObject(SetProps(MakeElement("Label", TitleStr, 13, 0.4), {
									...
									if DescStr then
										...
										table.insert(Elements, OrionLib:AddThemeObject(SetProps(MakeElement("Label", DescStr, 11, 0.4), {
									...
									local OptionBtn = OrionLib:AddThemeObject(SetProps(SetChildren(
                        ...
                        function ElementFunction:AddBind(BindConfig)
                                ...
                                local BindBox = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
                                        Size = UDim2.new(0, 24, 0, 24),
                                        Position = UDim2.new(1, -12, 0.5, 0),
                                        AnchorPoint = Vector2.new(1, 0.5)
                                }), {
                                        OrionLib:AddThemeObject(MakeElement("Stroke"), "Stroke"),
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", BindConfig.Name, 14), {
                                                Size = UDim2.new(1, 0, 1, 0),
                                                Font = Enum.Font.GothamBold,
                                                TextXAlignment = Enum.TextXAlignment.Center,
                                                Name = "Value"
                                ...
                                local BindFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                                        Size = UDim2.new(1, 0, 0, 38),
                                        Parent = ItemParent
                                }), {
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", BindConfig.Name, 15), {
                                                Size = UDim2.new(1, -12, 1, 0),
                                                Position = UDim2.new(0, 12, 0, 0),
                                                Font = Enum.Font.GothamBold,
                                                Visible = BindConfig.Visible,
                                ...
                                AddConnection(Click.MouseEnter, function()
                                        TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 3)}):Play()
                                end)
                                ...
                                AddConnection(Click.MouseButton1Down, function()
                                        TweenService:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 6)}):Play()
                                end)
                        ...
                        function ElementFunction:AddTextbox(TextboxConfig)
                                ...
                                local TextboxActual = OrionLib:AddThemeObject(Create("TextBox", {
                                        Size = UDim2.new(1, 0, 1, 0),
                                        BackgroundTransparency = 1,
                                        TextColor3 = Color3.fromRGB(255, 255, 255),
                                        PlaceholderColor3 = Color3.fromRGB(210,210,210),
                                ...
                                local TextContainer = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
                                ...
                                local TextboxFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
                                        Size = UDim2.new(1, 0, 0, 38),
                                        Parent = ItemParent
                                }), {
                                        OrionLib:AddThemeObject(SetProps(MakeElement("Label", TextboxConfig.Name, 15), {
                                                Size = UDim2.new(1, -12, 1, 0),
                                                Position = UDim2.new(0, 12, 0, 0),
                                                Font = Enum.Font.GothamBold,
                                                Visible = TextboxConfig.Visible,
                                ...
                                AddConnection(Click.MouseEnter, function()
                                        TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 3)}):Play()
                                end)
                                ...
                                AddConnection(Click.MouseButton1Down, function()
                                        TweenService:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {BackgroundColor3 = ColorAdd(GetThemeValue("Second", OrionLib.Themes.Default.Second), 6)}):Play()
                                end)
                        ...
                        function ElementFunction:AddColorpicker(ColorpickerConfig)
							...
							local ColorpickerBox = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
								Size = UDim2.new(0, 24, 0, 24),
								Position = UDim2.new(1, -12, 0.5, 0),
								AnchorPoint = Vector2.new(1, 0.5)
							}), {
							...
							local ColorpickerFrame = OrionLib:AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
								Size = UDim2.new(1, 0, 0, 38),
								Parent = ItemParent
							}), {
								SetProps(SetChildren(MakeElement("TFrame"), {
									OrionLib:AddThemeObject(SetProps(MakeElement("Label", ColorpickerConfig.Name, 15), {
										Size = UDim2.new(1, -12, 1, 0),
										Position = UDim2.new(0, 12, 0, 0),
										Font = Enum.Font.GothamBold,
										Name = "Content"
						...
						function ElementFunction:AddSection(SectionConfig)
							...
							local SectionFrame = SetChildren(SetProps(MakeElement("TFrame"), {
								...
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", SectionConfig.Name, 14), {
                            ...
                            SectionFunction.Button = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Button"; return SectionFunction:AddButton(config) end
                            SectionFunction.HighlightButton = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Highlight Button"; return SectionFunction:AddHighlightButton(config) end
                            SectionFunction.Toggle = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Toggle"; config.Default = config.Default ~= nil and config.Default or config.Value; return SectionFunction:AddToggle(config) end
                            SectionFunction.Slider = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Slider"; config.Default = config.Default ~= nil and config.Default or config.Value; return SectionFunction:AddSlider(config) end
                            SectionFunction.Dropdown = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Dropdown"; config.Default = config.Default ~= nil and config.Default or config.Value; return SectionFunction:AddDropdown(config) end
                            SectionFunction.Input = function(_, config) config = TranslateConfig(config or {}); config.Name = config.Name or config.Title or "Input"; config.Default = config.Default ~= nil and config.Default or config.Value; return SectionFunction:AddTextbox(config) end
                            SectionFunction.Paragraph = function(_, config) config = TranslateConfig(config or {}); return SectionFunction:AddParagraph(config.Title or config.Name or "Paragraph", config.Content or config.Desc or config.Description or "") end
                        ...
                        function ElementFunction:Space(config)
                            ...
                            return {Instance = frame, Destroy = function() frame:Destroy() end}
                        end
						...
						if TabConfig.PremiumOnly then
							...
							SetChildren(SetProps(MakeElement("TFrame"), {
								...
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", "Unauthorised Access", 14), {
								...
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", "Premium Features", 14), {
									Size = UDim2.new(1, -150, 0, 14),
									Position = UDim2.new(0, 150, 0, 112),
									Font = Enum.Font.GothamBold
								}), "Text"),
								OrionLib:AddThemeObject(SetProps(MakeElement("Label", "This part of the script is locked to Sirius Premium users. Purchase Premium in the Discord server (discord.gg/sirius)", 12), {
        ...
        function Functions:OnOpen(callback)
                if type(callback) == "function" then
                        AddConnection(MainWindow:GetPropertyChangedSignal("Visible"), function()
                                if MainWindow.Visible then OrionLib:SafeScript(callback) end
                        end)
                end
        end
        ...
        function Functions:OnClose(callback)
                if type(callback) == "function" then
                        AddConnection(MainWindow:GetPropertyChangedSignal("Visible"), function()
                                if not MainWindow.Visible then OrionLib:SafeScript(callback) end
                        end)
                end
        end
